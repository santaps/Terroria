...
namespace StarterMod.Items
{
    ...
    public class LearningBossSummon : ModItem
    {
        ...
        {
            DisplayName.SetDefault("LearningBoss Summon Item");
            Tooltip.SetDefault("Summons Flying Spaghetti Monster");
        ...
        public override bool CanUseItem(Player player)
        {
            ...
            return !NPC.AnyNPCs(ModContent.NPCType<LearningBossBody>());
        }
        ...
        public override bool? UseItem(Player player)
        {
            if (player.whoAmI == Main.myPlayer)
            {
                ...
                int type = ModContent.NPCType<LearningBossBody>();
